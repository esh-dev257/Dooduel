...
function floodFill(ctx, startX, startY, fillColor, width, height) {
  ...
  const [targetR, targetG, targetB, targetA] = [
    data[startIdx],
    data[startIdx + 1],
    data[startIdx + 2],
    data[startIdx + 3],
      ...
      <div className="flex-1 flex items-start lg:items-center justify-center p-1 pt-2 lg:p-6 min-h-0 [--canvas-max-h:calc(110vh-460px)] lg:[--canvas-max-h:calc(100vh-280px)]">
        ...
        >
          <canvas
            ...
            style={{
              maxWidth: "100%",
              maxHeight: "var(--canvas-max-h, calc(100vh - 280px))",
              width: "auto",
              aspectRatio: "800/560",
            }}
          ...
          <div className="hidden lg:flex flex-row items-center gap-3 px-4 py-2 bg-pixel-panel border-t-4 border-pixel-border flex-wrap flex-shrink-0">
            ...
            <div className="flex flex-row gap-1 flex-wrap">
              ...
              <label className="w-7 h-7 border-4 border-pixel-border shadow-pixel-sm cursor-pointer flex items-center justify-center bg-pixel-bgdark hover:border-pixel-gold transition-colors duration-75 relative">
                <span className="font-pixel text-[8px] text-white pointer-events-none">
                  +
                </span>
                <input
                  type="color"
            ...
            <div className="flex flex-row items-center gap-1">
              ...
              {SIZES.map((size, i) => (
                ...
                >
                  <div
                    className="bg-white"
                    style={{ width: DOT_SIZES[i], height: DOT_SIZES[i] }}
                  />
                </button>
              ))}
            </div>
          ...
          <div className="lg:hidden flex flex-col bg-pixel-panel border-t-4 border-pixel-border flex-shrink-0 px-2 pt-1 pb-3 gap-1">
            ...
            <div className="flex flex-row flex-wrap gap-1">
              ...
              <label className="w-5 h-5 border-2 border-pixel-border cursor-pointer flex items-center justify-center bg-pixel-bgdark relative">
                <span className="font-pixel text-[6px] text-white pointer-events-none">
                  +
                </span>
                <input
                  type="color"
